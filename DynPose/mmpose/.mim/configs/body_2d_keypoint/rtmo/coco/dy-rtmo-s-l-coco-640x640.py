...
# runtime
train_cfg = dict(max_epochs=5, val_interval=1, dynamic_intervals=[(580, 1)])
...
optim_wrapper = dict(
    ...
    optimizer=dict(type='AdamW', lr=0.00001, weight_decay=0.005),
    paramwise_cfg=dict(
        norm_decay_mult=0,
        bias_decay_mult=0,
        bypass_duplicate=True,
        force_default_settings=True,
        # custom_keys=dict({'neck.encoder': dict(lr_mult=0.00)})
        custom_keys={
                    'backbone': dict(lr_mult=0, decay_mult=0),
                    'neck': dict(lr_mult=0, decay_mult=0),
                    'head.head_module.net2': dict(lr_mult=0, decay_mult=0),
                    'head.dcc': dict(lr_mult=0, decay_mult=0),
                    'head.head_module.conv_cls': dict(lr_mult=0, decay_mult=0),
                    'head.head_module.conv_pose': dict(lr_mult=0, decay_mult=0),
                    'head.head_module.out_cls': dict(lr_mult=0, decay_mult=0),
                    'head.head_module.out_bbox': dict(lr_mult=0, decay_mult=0),
                    'head.head_module.out_kpt_reg': dict(lr_mult=0, decay_mult=0),
                    'head.head_module.out_kpt_vis': dict(lr_mult=0, decay_mult=0),
                    'head.head_module.out_pose': dict(lr_mult=0, decay_mult=0),
...
load_from = 'rtmo-s_8xb32-600e_body7-640x640-dac2bf74_20231211.pth'
