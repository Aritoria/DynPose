...
class BaseCocoStyleDataset(BaseDataset):
    ...
    def load_data_list(self) -> List[dict]:
        ...
        if self.bbox_file:
            ...
            if self.data_mode == 'topdown':
                print("I'm in topdown in : ",len(instance_list))
                data_list = self._get_topdown_data_infos(instance_list)
                # data_list = self._get_topdown_data_infos(instance_list)[0:28000]
                print("I'm in topdown out : ", len(data_list))
            else:
