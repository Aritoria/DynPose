...
class TopdownPoseEstimator(BasePoseEstimator):
    ...
    def predict(self, inputs: Tensor, data_samples: SampleList) -> SampleList:
        ...
        # if self.is_load == 0:
        #     self.load_checkpoint("td-hm_res50_8xb64-210e_coco-256x192-04af38ce_20220923.pth", 'cpu', False)
        #     self.is_load = 1
    ...
    def load_checkpoint(self,
        ...
        print("Loaded td-hm_res50_8xb64-210e_coco-256x192-04af38ce_20220923.pth checkpoint")
        return checkpoint
