...
class ImageRouterRTMO(BaseBackbone):

    def __init__(self):
        # Protect mutable default arguments
        super(ImageRouterRTMO, self).__init__()
        ...
        self.layer1 = nn.Conv2d(2304, 512, kernel_size=1, bias=True)
...
#         xs = [x.unsqueeze(-1).unsqueeze(-1) for x in xs] # sig
