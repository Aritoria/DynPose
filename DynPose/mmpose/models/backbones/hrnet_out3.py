...
class HRNetOut3(BaseBackbone):
    ...
    def init_weights(self):
        ...
        super(HRNetOut3, self).init_weights()
    ...
    def forward(self, x):
        ...
        # print("333: ", y_list[0].shape, y_list[1].shape, y_list[2].shape)
        out.append(y_list)
        ...
        # print("444:", y_list[0].shape, y_list[1].shape, y_list[2].shape, y_list[3].shape)
        out.append(y_list)
