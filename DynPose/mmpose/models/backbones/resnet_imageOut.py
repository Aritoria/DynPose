...
class ResNetImageOut(BaseBackbone):
    ...
    def __init__(self,
        ...
        # Protect mutable default arguments
        norm_cfg = copy.deepcopy(norm_cfg)
        super(ResNetImageOut, self).__init__(init_cfg)
    ...
    def init_weights(self):
        ...
        super(ResNetImageOut, self).init_weights()
...
@MODELS.register_module()
class ResNet_With_Image(ResNetImageOut):
