...
#         self.pconv3 = Partial_conv3(128)
#         self.conv3 = nn.Conv2d(in_channels=128, out_channels=128, stride=1, kernel_size=1)
#         self.conv3_1 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=2, padding=1)
#         self.conv4 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=3, stride=2, padding=1)
#         self.pconv5 = Partial_conv3(256)
#         self.conv5 = nn.Conv2d(in_channels=256, out_channels=256, stride=1, kernel_size=1)
#         self.conv5_1 = nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=2, padding=1)
#         self.conv6 = nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=2, padding=1)
#
#         self.sigmoid = nn.Sigmoid()
#         # self.router = AdaptiveRouter([256],3)
#
#         norm_cfg = dict(type='BN')
#         self.norm1_name, norm1 = build_norm_layer(
#             norm_cfg, 64, postfix=1)
#         self.norm2_name, norm2 = build_norm_layer(
#             norm_cfg, 128, postfix=2)
#         self.norm3_name, norm3 = build_norm_layer(
#             norm_cfg, 128, postfix=3)
#         self.norm4_name, norm4 = build_norm_layer(
#             norm_cfg, 256, postfix=4)
#         self.norm5_name, norm5 = build_norm_layer(
#             norm_cfg, 256, postfix=5)
#         self.norm6_name, norm6 = build_norm_layer(
#             norm_cfg, 256, postfix=6)
#         self.norm7_name, norm7 = build_norm_layer(
#             norm_cfg, 128, postfix=7)
#         self.norm8_name, norm8 = build_norm_layer(
#             norm_cfg, 256, postfix=8)
#
...
#
#         self.layer1 = nn.Conv2d(3072, 512, kernel_size=1, bias=True)
#         self.layer2 = nn.Conv2d(512, 3, kernel_size=1, bias=True)
#
...
#         x = self.layer2(x).flatten().unsqueeze(0)
#         score = x.sigmoid()
#         outs.append(score)
#
#         return tuple(outs)
