...
class HeatmapHeadImageMultiIn(BaseHead):
    ...
    def __init__(self,
        ...
        self.router = AdaptiveRouter([256,512,1024,2048], 1, reduction=16)
    ...
    def forward(self, feats: tuple[Tensor]) -> Tensor:
        ...
        x = feat_and_image[3]
        # print(feat_and_image[0].shape)
        # print(feat_and_image[1].shape)
        # print(feat_and_image[2].shape)
        # print(feat_and_image[3].shape)


        router_result = self.router([feat_and_image[0],feat_and_image[1],feat_and_image[2],feat_and_image[3]]) # [bs,1]
    ...
    def loss(self,
        ...
        loss = (1.0 - score)*(loss_head1-(delt/2.0)) + score*(loss_head2+(delt/2.0))
...
#         self.is_load = 0
#
#         self.router = AdaptiveRouter([256,512,1024,2048], 2, reduction=16)
#
#     def _make_conv_layers(self, in_channels: int,
#                           layer_out_channels: Sequence[int],
#                           layer_kernel_sizes: Sequence[int]) -> nn.Module:
